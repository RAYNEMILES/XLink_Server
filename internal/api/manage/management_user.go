...
func GetAllUsersUid(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{"errCode": 400, "errMsg": "call GetAllUsersUid users rpc server failed"})
		return
	}
...
func AccountCheck(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusBadRequest, gin.H{"errCode": 400, "errMsg": "call AccountCheck users rpc server failed"})
		return
	}
