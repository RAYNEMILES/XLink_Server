...
import (
	...
	common2 "Open_IM/cmd/Open-IM-SDK-Core/internal/obj_storage"
	"Open_IM/cmd/Open-IM-SDK-Core/open_im_sdk_callback"
	"Open_IM/cmd/Open-IM-SDK-Core/pkg/constant"
	config2 "Open_IM/pkg/common/config"
...
func InitSDK(listener open_im_sdk_callback.OnConnListener, operationID string, config string) bool {
	...
	if config2.Config.Log.RemainLogLevel != 0 {
		log.NewPrivateLog(constant.LogFileName)
	} else {
		if sdk_struct.SvrConf.LogLevel != 0 {
			log.PrivateLog("", sdk_struct.SvrConf.LogLevel, 24, 3, config2.Config.Log.ElasticSearchSwitch)
		} else {
			log.PrivateLog("", 6, 24, 3, config2.Config.Log.ElasticSearchSwitch)
		}
	}
...
func Reconnect(callback open_im_sdk_callback.Base, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
func WakeUp(callback open_im_sdk_callback.Base, operationID string) {
	...
	if err := CheckResourceLoad(userForSDK); err != nil {
		...
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	}
...
func RemoveFaceUrl(callback open_im_sdk_callback.Base, operationID string, userInfo string) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	}
	userForSDK.User().RemoveFaceUrl(callback, userInfo, operationID)
}
...
func GetGroupMemberList(callback open_im_sdk_callback.Base, operationID string, groupID string, filter, offset, count int32, nameSearch string) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	}
	userForSDK.Group().GetGroupMemberList(callback, groupID, filter, offset, count, nameSearch, operationID)
}
...
func SyncGroupUpdatesVersionByGroupIDV2(callback open_im_sdk_callback.Base, groupID, operationID string) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	}
	userForSDK.Group().SyncGroupUpdatesVersionByGroupIDV2(callback, groupID, operationID)
}

func GetGroupMembersSyncStatus(callback open_im_sdk_callback.Base, groupID, operationID string) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	}
	userForSDK.Group().GetGroupMembersSyncStatus(callback, groupID, operationID)
}
func GetFriendListNotMemberOfTheGroup(callback open_im_sdk_callback.Base, groupID, operationID string) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	}
	userForSDK.Group().GetFriendListNotMemberOfTheGroup(callback, groupID, operationID)
}
...
func GetFriendRemarkorNick(callback open_im_sdk_callback.Base, operationID string, userIDGroupID string) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, constant.ErrResourceLoadNotComplete.ErrMsg)
		return
	}
	userForSDK.Friend().GetFriendRemarkOrNick(callback, userIDGroupID, operationID)
}
func GetUserRemarkLocal(callback open_im_sdk_callback.Base, operationID string, userID string) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, constant.ErrResourceLoadNotComplete.ErrMsg)
		return
	}
	userForSDK.Friend().GetUserRemarkLocal(callback, userID, operationID)
}
...
func GetFriendApplicationList(callback open_im_sdk_callback.Base, operationID string) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	}
	userForSDK.Friend().GetFriendApplicationList(callback, operationID)
}
...
func GetOneConversation(callback open_im_sdk_callback.Base, operationID string, sessionType int, sourceID string) {
	...
	//go func() {
	//	userForSDK.Group().SyncJoinedGroupList(operationID)
	//}()
}

func GetAllConversationListByType(callback open_im_sdk_callback.Base, conversationType []int32, operationID string) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	}
	userForSDK.Conversation().GetAllConversationListByType(callback, conversationType, operationID)
}

// func GetUserIPandStatus(callback open_im_sdk_callback.Base, operationID, requestString string) {
// 	if err := CheckResourceLoad(userForSDK); err != nil {
// 		log.Error(operationID, "resource loading is not completed ", err.Error())
// 		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
// 		return
// 	}
// 	userForSDK.Conversation().GetUserIPandStatus(callback, requestString, operationID)
// }
...
func CreateEmojiMessage(operationID string, text string) string {
	return userForSDK.Conversation().CreateEmojiMessage(text, operationID)
}
...
func CreateArticleMessage(Text, ArticleID, ArticleTitle, ArticleCoverPhoto, ArticleDetailsUrl, OfficialID, OfficialName, OfficialFaceUrl, operationID string) string {
	return userForSDK.Conversation().CreateArticleMessage(Text, ArticleID, ArticleTitle, ArticleCoverPhoto, ArticleDetailsUrl, OfficialID, OfficialName, OfficialFaceUrl, operationID)
}

func CreateWoomMessage(fileId, coverUrl, mediaUrl, userId, nickname, faceUrl, operationID, desc string) string {
	return userForSDK.Conversation().CreateWoomMessage(fileId, coverUrl, mediaUrl, userId, nickname, faceUrl, operationID, desc)
}
...
func CreateCallingMessage(operationID string, messageType, banStatus int8, errCode int32, duration int64) string {
	return userForSDK.Conversation().CreateCallingMessage(messageType, banStatus, errCode, duration, operationID)
}
...
func CreateWalletTransferMessage(operationID string, Text, TransactionID, SenderID, Currency string, Amount string) string {
	return userForSDK.Conversation().CreateWalletTransferMessage(Text, TransactionID, SenderID, Currency, operationID, Amount)
}

func CreateOfficialAccountMessage(operationID string, Text string, OfficialID int32, Nickname, FaceURL, Bio string, FollowTime, Type int32) string {
	return userForSDK.Conversation().CreateOfficialAccountMessage(Text, OfficialID, Nickname, FaceURL, Bio, FollowTime, Type, operationID)
}

func GetRecentForwardConversations(callback open_im_sdk_callback.Base, operationID string) {
	userForSDK.Conversation().GetRecentForwardConversations(callback, operationID)
}

func UpdateOfficialAccountConversations(operationID string) {
	go userForSDK.Conversation().GetOfficialAccountConversationFormServer(operationID)
}
...
func SendCallingMessage(callback open_im_sdk_callback.SendMsgCallBack, operationID, message, offlinePushInfo string, communicationID int64) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	}
	userForSDK.Conversation().SendCallingMessage(callback, message, communicationID, offlinePushInfo, operationID)

}

func GetCallingMessages(callback open_im_sdk_callback.SendMsgCallBack, operationID, userID, searchKey string, errCode, startTime, endTime int64) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	}
	userForSDK.Conversation().GetCallingMessages(callback, operationID, userID, searchKey, errCode, startTime, endTime)
}

// SendBroadCastMessage
func SendBroadCastMessage(callback open_im_sdk_callback.SendMsgCallBack, operationID, message, recvID, groupID, actionType, offlinePushInfo string) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	}
	var reciverIDslice []string
	var groupIDslice []string
	err := json.Unmarshal([]byte(recvID), &reciverIDslice)
	if err != nil {
		callback.OnError(constant.ErrArgs.ErrCode, "receive user id list format is incorrect")
		return
	}
	err = json.Unmarshal([]byte(groupID), &groupIDslice)
	if err != nil {
		callback.OnError(constant.ErrArgs.ErrCode, "receive group id list format is incorrect")
		return
	}

	// userForSDK.Conversation().SendBroadCastMessage(callback, message, reciverIDslice, groupIDslice, actionType, offlinePushInfo, operationID)
	userForSDK.Conversation().SendBroadCastMessageV3(callback, message, reciverIDslice, groupIDslice, actionType, offlinePushInfo, operationID)

}

func GetBroadcastMessageList(callback open_im_sdk_callback.Base, operationID string, pageNumber int32) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	...
	userForSDK.Conversation().GetBroadcastMessageList(callback, pageNumber, operationID)

}
func GetBroadcastMessageReceiverList(callback open_im_sdk_callback.Base, operationID string, clientMsgID string) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	...
	userForSDK.Conversation().GetBroadcastMessageReceiverList(callback, clientMsgID, operationID)

}

func GetBroadcastList(callback open_im_sdk_callback.Base, operationID, userID string) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	...
	userForSDK.Conversation().GetBroadcastList(callback, userID, operationID)

}

func ClearBroadcast(callback open_im_sdk_callback.Base, operationID, userID string) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	...
	userForSDK.Conversation().ClearBroadcast(callback, userID, operationID)
...
func GetHistoryMessageListByStartMsgId(callback open_im_sdk_callback.Base, operationID, getMessageOptions string) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	}
	userForSDK.Conversation().GetHistoryMessageListByStartMsgId(callback, getMessageOptions, operationID)
}
...
func RevokeMessage(callback open_im_sdk_callback.Base, operationID string, message string) {
	log.NewInfo(operationID, utils.GetSelfFuncName(), "call revoke api")
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
...
func NewRevokeMessage(callback open_im_sdk_callback.Base, operationID string, message string) {
	log.NewInfo(operationID, utils.GetSelfFuncName(), "call new revoke api")
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
...
func MarkOfficialMessageAsRead(callback open_im_sdk_callback.Base, operationID string, userID string, msgIDList string) {
	if err := CheckResourceLoad(userForSDK); err != nil {
		log.Error(operationID, "resource loading is not completed ", err.Error())
		callback.OnError(constant.ErrResourceLoadNotComplete.ErrCode, err.Error()+",function:"+utils.GetSelfFuncName())
		return
	}
	userForSDK.Conversation().MarkOfficialMessageAsRead(callback, userID, msgIDList, operationID)
}
...
func CheckToken(userID, token string, platformID int32) error {
	err, _ := login.CheckToken(userID, token, platformID, "")
	return err
}
