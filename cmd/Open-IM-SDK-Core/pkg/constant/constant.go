...
const (
	...
	UserNotFriendNotification   = 1304
	UserBlockedYouNotification  = 1305
	...
	GroupDeleteNotification                  = 1520
	GroupNotificationEnd                     = 1599
	GroupMemberSyncSilentSDKNotification     = 1521
...
const (
	...
	PostGroupAnnouncement        = 14
	NotificationCountSetZero     = 15
...
const BigVersion = "v1"
const UpdateVersion = ".1.3"
const SdkVersion = "Open-IM-SDK-Core-"
const LogFileName = "open_im_sdk_server.log"
...
const (
	RegisterTypeByMobile   = 1
	RegisterTypeByPassword = 2
)

const (
	CallingDuration = 10000
	CallingCancel = 2001
	CallingFailed = 2002
	CallingMissedCall = 2003
	CallingNoNetwork = 2004
	CallingInterruption = 2005
)
