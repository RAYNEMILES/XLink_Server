...
const (
	...
	GetFriendsInfo                     = "/friend/get_friends"
	AddFriendResponse                  = "/friend/add_friend_response"
	SetFriendRemark                    = "/friend/set_friend_remark"
	GetFriendRemarkOrNick              = "/friend/get_friend_remark_nick"
	...
	GetMaxSeqRouter        = "/msg/get_max_seq"
	GetGroupMinSeqRouter   = "/msg/get_group_min_seq"

	SwitchBroadcastRouter    = "/msg/switch_broadcast"
	GetBroadcastStatusRouter = "/msg/get_broadcast_status"
	...
	GetGroupAllMemberListRouterV2         = RouterGroup + "/get_group_member_list_v2"
	...
	GroupUpdateVersion                    = RouterGroup + "/get_group_update_version"
	CheckLocalGroupUpdatesVersionsWithSrv = RouterGroup + "/check_group_update_version"
	...
	UpdateUserIPandStatus     = RouterAuth + "/updateIpUserStatus"
	GetUserIPandStatusRouter  = RouterAuth + "/getIpUserStatus"
	...
	GetOfficialAccountConversation = Official + "/followed_official_conv"

	// communication
	GetMembersByRoomIDReq = Third + "/get_members_by_communication_id"
)
const (
	RouterGroup        = "/group"
