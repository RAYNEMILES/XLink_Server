...
type GetGroupMembersInfoResp struct {
	CommResp
	MemberList []*sdk.GroupMemberFullInfo `json:"-"`
	Data       []map[string]interface{}   `json:"data"`
}
...
type GetGroupMemberListResp struct {
	CommResp
	NextSeq    int32 `json:"nextSeq"`
	MemberList []*sdk.GroupMemberFullInfo
	Data       []map[string]interface{} `json:"data"`
}
...
type CreateGroupReq struct {
	...
	GroupInterest []int32               `json:"groupInterest"`
}
...
type GetGroupApplicationListResp struct {
	CommResp
	GroupRequestList []*sdk.GroupRequest
	Data             []map[string]interface{} `json:"data"`
}
...
type GetUserRespGroupApplicationResp struct {
	CommResp
	GroupRequestList []*sdk.GroupRequest `json:"-"`
}
...
type GetGroupInfoResp struct {
	CommResp
	GroupInfoList []*sdk.GroupInfo         `json:"-"`
	Data          []map[string]interface{} `json:"data"`
}

type GetGroupMemberListSrvReq struct {
...
type GroupUpdatesVersionsReq struct {
	OperationID string   `json:"operationID"`
	GroupIDs    []string `json:"groupIDs" binding:"required"`
}
type CheckLocalGroupUpdatesVersionsWithSrvReq struct {
	OperationID       string `json:"operationID"`
	GroupID           string `json:"groupID" binding:"required"`
	GroupVersion      int64  `json:"groupVersion"`
	PageNumber        int32  `json:"pageNumber"`
	PageSize          int32  `json:"pageSize"`
	NeedNextPageFetch bool   `json:"needNextPageFetch"`
	ResponseBackHTTP  bool   `json:"responseBackHTTP"`
}
