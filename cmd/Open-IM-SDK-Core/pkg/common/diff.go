...
func friendCopyToLocal(localFriend *model_struct.LocalFriend, apiFriend *sdk.FriendInfo) {
...
func friendRequestCopyToLocal(localFriendRequest *model_struct.LocalFriendRequest, apiFriendRequest *sdk.FriendRequest) {
	copier.Copy(localFriendRequest, apiFriendRequest)
}

func blackCopyToLocal(localBlack *model_struct.LocalBlack, apiBlack *sdk.PublicUserInfo, ownerUserID string) {
	copier.Copy(localBlack, apiBlack)
	localBlack.OwnerUserID = ownerUserID
	localBlack.BlockUserID = apiBlack.UserID
}

func TransferToLocalFriend(apiFriendList []*sdk.FriendInfo) []*model_struct.LocalFriend {
...
func TransferToLocalGroupMember(apiData []*sdk.GroupMemberFullInfo) []*model_struct.LocalGroupMember {
...
func GroupMemberCopyToLocal(dst *model_struct.LocalGroupMember, src *sdk.GroupMemberFullInfo) {
	copier.Copy(dst, src)
}

func TransferToLocalGroupInfo(apiData []*sdk.GroupInfo) []*model_struct.LocalGroup {
...
func GroupInfoCopyToLocal(dst *model_struct.LocalGroup, src *sdk.GroupInfo) {
	copier.Copy(dst, src)
}

func TransferToLocalGroupRequest(apiData []*sdk.GroupRequest) []*model_struct.LocalGroupRequest {
...
func GroupRequestCopyToLocal(dst *model_struct.LocalGroupRequest, src *sdk.GroupRequest) {
	copier.Copy(dst, src)
...
func AdminGroupRequestCopyToLocal(dst *model_struct.LocalAdminGroupRequest, src *sdk.GroupRequest) {
	copier.Copy(dst, src)
	copier.Copy(dst, src.GroupInfo)
	copier.Copy(dst, src.UserInfo)
	dst.GroupFaceURL = src.GroupInfo.FaceURL
...
func SendGroupRequestCopyToLocal(dst *model_struct.LocalGroupRequest, src *sdk.GroupRequest) {
	copier.Copy(dst, src)
	copier.Copy(dst, src.GroupInfo)
	copier.Copy(dst, src.UserInfo)
	dst.GroupFaceURL = src.GroupInfo.FaceURL
...
func TransferToLocalUserInfo(apiData *sdk.UserInfo) *model_struct.LocalUser {
	var localNode model_struct.LocalUser
	copier.Copy(&localNode, apiData)
	return &localNode
}

func TransferToLocalFriendRequest(apiFriendList []*sdk.FriendRequest) []*model_struct.LocalFriendRequest {
...
func TransferToLocalBlack(apiBlackList []*sdk.PublicUserInfo, ownerUserID string) []*model_struct.LocalBlack {
...
func TransferToLocalAdminGroupRequest(apiData []*sdk.GroupRequest) []*model_struct.LocalAdminGroupRequest {
...
func TransferToLocalDepartmentMember(apiData []*sdk.UserDepartmentMember) []*model_struct.LocalDepartmentMember {
...
func TransferToLocalDepartment(apiData []*sdk.Department) []*model_struct.LocalDepartment {
...
func TransferToLocalSendGroupRequest(apiData []*sdk.GroupRequest) []*model_struct.LocalGroupRequest {
	local := make([]*model_struct.LocalGroupRequest, 0)
	for _, v := range apiData {
		var node model_struct.LocalGroupRequest
...
func TransferToLocalConversation(resp server_api_params.GetAllConversationsResp) []*model_struct.LocalConversation {
	...
	for _, serverConversation := range resp.Conversations {
		localConversations = append(localConversations, &model_struct.LocalConversation{
			...
			IsPrivateChat:    serverConversation.IsPrivateChat,
			IsPinned:         serverConversation.IsPinned,
			PinnedTime:       serverConversation.PinnedTime,
			GroupAtType:      serverConversation.GroupAtType,
			IsNotInGroup:     serverConversation.IsNotInGroup,
			AttachedInfo:     serverConversation.AttachedInfo,
			UnreadCount:      serverConversation.UnreadCount,
...
func TransferToOneLocalConversation(resp server_api_params.GetConversationResp) *model_struct.LocalConversation {
	localConversation := model_struct.LocalConversation{
		RecvMsgOpt:       resp.Conversation.RecvMsgOpt,
		ConversationID:   resp.Conversation.ConversationID,
		ConversationType: resp.Conversation.ConversationType,
		UserID:           resp.Conversation.UserID,
		GroupID:          resp.Conversation.GroupID,
		IsPrivateChat:    resp.Conversation.IsPrivateChat,
		IsPinned:         resp.Conversation.IsPinned,
		PinnedTime:       resp.Conversation.PinnedTime,
		GroupAtType:      resp.Conversation.GroupAtType,
		IsNotInGroup:     resp.Conversation.IsNotInGroup,
		AttachedInfo:     resp.Conversation.AttachedInfo,
		UnreadCount:      resp.Conversation.UnreadCount,
		Ex:               resp.Conversation.Ex,
	}
