...
type GetFriendRemarkOrNickParams struct {
	ForUserID string `json:"forUserID" validate:"required"`
	GroupID   string `json:"groupID"`
}
type LocalFriendRemark struct {
	FriendUserID string `json:"friendID"`
