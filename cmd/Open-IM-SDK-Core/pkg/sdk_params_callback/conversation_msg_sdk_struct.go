...
type GetHistoryMessageListByStartMsgIdParams struct {
	UserID           string `json:"userID"`
	GroupID          string `json:"groupID"`
	ConversationID   string `json:"conversationID"`
	StartClientMsgID string `json:"startClientMsgId"`
	EndClientMsgID   string `json:"endClientMsgId" Binding:"required"`
}
...
type SearchLocalMessagesParams struct {
	...
	// 0 all, 1 has link, 2 haven't link
	HasLink            int   `json:"hasLink"`
