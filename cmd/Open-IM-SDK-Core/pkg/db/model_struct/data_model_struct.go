...
type LocalFriend struct {
	...
	Birth          string `gorm:"column:birth;type:varchar(32)" json:"birth"`
	...
	// SuperUserStatus int32  `gorm:"column:super_user_status" json:"superUserStatus"`
}
...
type LocalFriendRequest struct {
	...
	FromPhoneNumber string `gorm:"column:from_phone_number;size:32" json:"fromPhoneNumber"`
	FromEmail       string `gorm:"column:from_email;size:64" json:"fromEmail"`
	...
	ToPhoneNumber string `gorm:"column:to_phone_number;size:32" json:"toPhoneNumber"`
	ToEmail       string `gorm:"column:to_email;size:64" json:"toEmail"`
...
type LocalChatLog struct {
	...
	SendID           string `gorm:"column:send_id;type:char(64);index:index_send_time,priority:1" json:"sendID"`
	RecvID           string `gorm:"column:recv_id;type:char(64);index:index_send_time,priority:2" json:"recvID"`
	...
	Status           int32  `gorm:"column:status" json:"status"`
	Seq              uint32 `gorm:"column:seq" json:"seq"`
	SortTime         int64  `gorm:"column:sort_time" json:"sort_time"`
	SendTime         int64  `gorm:"column:send_time" json:"sendTime"`
	CreateTime       int64  `gorm:"column:create_time" json:"createTime"`
	AttachedInfo     string `gorm:"column:attached_info;type:varchar(1024)" json:"attachedInfo"`
	HasLink          bool   `gorm:"column:has_link" json:"has_link"`
	Ex               string `gorm:"column:ex;type:varchar(1024)" json:"ex"`
	AccountStatus    int8   `gorm:"column:account_status;size:1;default:1;comment:'1 active 2 Deleted'"`
}
...
type LocalBroadcastChatLog struct {
	ClientMsgID      string `gorm:"column:client_msg_id;primary_key;type:char(64)" json:"clientMsgID"`
	ServerMsgID      string `gorm:"column:server_msg_id;type:char(64)" json:"serverMsgID"`
	SendID           string `gorm:"column:send_id;type:char(64)" json:"sendID"`
	SenderPlatformID int32  `gorm:"column:sender_platform_id" json:"senderPlatformID"`
...
type LocalBroadcastMsgReceiver struct {
	ClientMsgID      string `gorm:"column:client_msg_id;type:char(64)" json:"clientMsgID"`
	ServerMsgID      string `gorm:"column:server_msg_id;type:char(64)" json:"serverMsgID"`
	ReceiverID       string `gorm:"column:send_id;type:char(64);index:index_send_time,priority:2" json:"sendID"`
	ReceiverNickname string `gorm:"column:sender_nick_name;type:varchar(255)" json:"senderNickname"`
	ReceiverFaceURL  string `gorm:"column:sender_face_url;type:varchar(255)" json:"senderFaceURL"`
	Status           int32  `gorm:"column:status;index:index_send_time,priority:4" json:"status"`
	ReceiverType     int64  `gorm:"column:receiver_type" json:"receiverType"`
	CreateTime       int64  `gorm:"column:create_time" json:"createTime"`
}

type BroadcastMessageList struct {
	LocalBroadcastChatLog         LocalBroadcastChatLog       `json:"local_broadcast_chat_log"`
	LocalBroadcastMsgReceiverList []LocalBroadcastMsgReceiver `json:"local_broadcast_msg_receiver_list"`
	TotalReceiverCount            int32                       `json:"total_receiver_count"`
}
...
type LocalConversation struct {
	...
	AttachedInfo             string `gorm:"column:attached_info;type:varchar(1024)" json:"attachedInfo"`
	Ex                       string `gorm:"column:ex;type:varchar(1024)" json:"ex"`
	LastForwardedMessageTime int64  `gorm:"column:last_forwarded_message_time;default:0" json:"lastForwardedMessageTime"`
	UnreadNotificationCount  int32  `gorm:"column:unread_notifications_count" json:"unreadNotificationCount"`
	AccountStatus            int8   `gorm:"column:account_status;size:1;default:1;comment:'1 active 2 Deleted'"`
}

type LocalArchivedConversation struct {
	LocalConversation
}
...
type LocalConfig struct {
	UserID       string `gorm:"column:user_id;primary_key;size:64" json:"userID"`
	FirstWelcome int    `gorm:"column:first_welcome;size:1;default:1" json:"firstWelcome"` //1 firstTime, 2 not firstTime
}

type LocalGroupUpdatesVersion struct {
...
type LocalBroadcast struct {
	...
	Receiver    string `gorm:"column:receiver; comment:'json format, recvID, msgType[1 user, 2 group]'" json:"receiver"`
	ContentType int32  `gorm:"column:content_type" json:"contentType"`
	FailedRecvs string `gorm:"failed_recvs;comment:'json format, recvID, msgType[1 user, 2 group]'" json:"failed_recvs"`
...
type LocalSeqSynced struct {
	ConversationID string `gorm:"column:conversation_id;primary_key;type:char(64)" json:"conversationID"`
	Seq            uint32 `gorm:"column:seq" json:"seq"`
}
