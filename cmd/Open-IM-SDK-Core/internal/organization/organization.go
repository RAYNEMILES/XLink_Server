...
func (o *Organization) DoNotification(msg *sdk2.MsgData, conversationCh chan common.Cmd2Value, operationID string) {
	if o.listener == nil {
		return
	}
...
func (o *Organization) getSubDepartmentFromSvr(departmentID string, operationID string) ([]*sdk2.Department, error) {
	var apiReq api.GetSubDepartmentReq
	apiReq.OperationID = operationID
	apiReq.DepartmentID = departmentID
	var realData []*sdk2.Department
...
func (o *Organization) getAllDepartmentFromSvr(operationID string) ([]*sdk2.Department, error) {
	return o.getSubDepartmentFromSvr("-1", operationID)
}

func (o *Organization) getAllDepartmentMemberFromSvr(operationID string) ([]*sdk2.UserDepartmentMember, error) {
	return o.getDepartmentMemberFromSvr("-1", operationID)
}

func (o *Organization) getDepartmentMemberFromSvr(departmentID string, operationID string) ([]*sdk2.UserDepartmentMember, error) {
	var apiReq api.GetDepartmentMemberReq
	apiReq.OperationID = operationID
	apiReq.DepartmentID = departmentID
	var realData []*sdk2.UserDepartmentMember
...
func (o *Organization) organizationChangedNotification(msg *sdk2.MsgData, operationID string) {
