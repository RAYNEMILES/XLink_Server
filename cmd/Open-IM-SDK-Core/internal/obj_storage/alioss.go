...
func (c *OSS) UploadImage(filePath string, clientMsgId string, onProgressFun func(int)) (string, string, error) {
	return c.uploadObj(filePath, "img", onProgressFun)

}

func (c *OSS) UploadSound(filePath string, clientMsgId string, onProgressFun func(int)) (string, string, error) {
	return c.uploadObj(filePath, "", onProgressFun)
}

func (c *OSS) UploadFile(filePath string, clientMsgId string, onProgressFun func(int)) (string, string, error) {
	return c.uploadObj(filePath, "", onProgressFun)
}

func (c *OSS) UploadVideo(videoPath, snapshotPath string, clientMsgId string, onProgressFun func(int)) (string, string, string, string, error) {
...
func (c *OSS) StopUpload(clientMsgId string) {
}
