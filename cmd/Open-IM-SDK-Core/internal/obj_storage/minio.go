...
func (m *Minio) UploadImage(filePath string, clientMsgId string, onProgressFun func(int)) (string, string, error) {
	return m.upload(filePath, "img	", onProgressFun)
}

func (m *Minio) UploadSound(filePath string, clientMsgId string, onProgressFun func(int)) (string, string, error) {
	return m.upload(filePath, "", onProgressFun)
}

func (m *Minio) UploadFile(filePath string, clientMsgId string, onProgressFun func(int)) (string, string, error) {
	return m.upload(filePath, "", onProgressFun)
}

func (m *Minio) UploadVideo(videoPath, snapshotPath string, clientMsgId string, onProgressFun func(int)) (string, string, string, string, error) {
...
func (c *Minio) StopUpload(clientMsgId string) {
}
