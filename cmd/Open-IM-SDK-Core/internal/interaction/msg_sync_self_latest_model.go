...
func (m *SelfMsgSyncLatestModel) doPushSingleMsg(cmd common.Cmd2Value) {
	...
	if msg.Seq == 0 {
		m.TriggerCmdNewMsgCome([]*sdk.MsgData{msg}, operationID, constant.MsgSyncModelDefault, 0)
		return
	}
...
//1
func (m *SelfMsgSyncLatestModel) TriggerCmdNewMsgCome(msgList []*sdk.MsgData, operationID string, syncFlag int, currentMaxSeq uint32) {
	for {
