...
type MsgStruct struct {
	...
	OfflinePush      sdk.OfflinePushInfo `json:"offlinePush,omitempty"`
	...
	ArticleElem      struct {
		...
		ArticleDetailsUrl string `json:"articleDetailsUrl,omitempty"`
		ArticleCoverPhoto string `json:"articleCoverPhoto,omitempty"`
		OfficialID        string `json:"officialID,omitempty"`
		OfficialName      string `json:"officialName,omitempty"`
		OfficialFaceUrl   string `json:"officialFaceUrl,omitempty"`
	} `json:"articleElem,omitempty"`
	WoomElem struct {
	...
	} `json:"woomElem,omitempty"`
	WalletTransferElem struct {
		Content       string `json:"content,omitempty"`
		TransactionID string `json:"transactionID,omitempty"`
		SenderID      string `json:"senderID,omitempty"`
		Amount        string `json:"amount,omitempty"`
		Currency      string `json:"currency,omitempty"`
	} `json:"walletTransferElem,omitempty"`
	OfficialAccountElem struct {
		Content    string `json:"content,omitempty"`
		OfficialID int32  `json:"officialID,omitempty"`
		Nickname   string `json:"nickname,omitempty"`
		FaceURL    string `json:"faceURL,omitempty"`
		Bio        string `json:"bio,omitempty"`
		FollowTime int32  `json:"followTime,omitempty"`
		Type       int32  `json:"type,omitempty"`
	} `json:"officialAccountElem,omitempty"`
	CallingElem struct {
		MessageType int8  `json:"message_type"`
		BanStatus   int8  `json:"ban_status"`
		ErrCode     int32 `json:"err_code"`
		Duration    int64 `json:"duration"`
	} `json:"callingElem,omitempty"`
}

type BroadcastMsgStruct struct {
	MsgStruct
	ReceiverUserIDs  []string `json:"receiverUserIDs,omitempty"`
	ReceiverGroupIDs []string `json:"receiverGroupIDs,omitempty"`
}
...
type CmdMaxSeqToMsgSync struct {
	...
	OperationID            string
	MinSeqOnSvr            uint32
	GroupID2MinMaxSeqOnSvr map[string]*sdk.MaxAndMinSeq
}
