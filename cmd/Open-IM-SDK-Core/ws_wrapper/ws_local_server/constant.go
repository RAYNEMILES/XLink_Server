...
//var UserRouteMap map[string]map[string]RefRouter
var UserRouteMapNew map[string]RefRouter
...
var statusText = map[int]string{
	...
	StatusBadParameter: "Request Parameter Error",
	StatusLoginPending: "Login Pending, Try after 5 seconds",
	StatusNoLogin:      "No Login, first Login",
}
