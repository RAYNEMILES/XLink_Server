...
type GetGameStatisticsResp struct {
	GamePlayedToday   int64 `json:"game_played_today"`
	CumulativePlayed  int64 `json:"cumulative_played"`
	GamePlayedNumList []struct {
		Data string `json:"data"`
		Num  int64  `json:"num"`
	} `json:"game_played_num_list"`
	ActiveGameList []struct {
		GameCode     string            `json:"game_code"`
		GameName     map[string]string `json:"game_name"`
		PlayedNumber int64             `json:"played_number"`
	}
}
