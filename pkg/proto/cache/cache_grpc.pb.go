...
type CacheClient interface {
	...
	// broadcast
	SwitchBroadcast(ctx context.Context, in *SwitchBroadcastReq, opts ...grpc.CallOption) (*SwitchBroadcastResp, error)
	GetBroadcast(ctx context.Context, in *GetBroadcastReq, opts ...grpc.CallOption) (*GetBroadcastResp, error)
	AddBlackFriendsForMomentsToCache(ctx context.Context, in *AddBlackFriendsToCacheReq, opts ...grpc.CallOption) (*AddBlackFriendsToCacheResp, error)
	ReduceBlackFriendsForMomentsFromCache(ctx context.Context, in *ReduceBlackFriendsFromCacheReq, opts ...grpc.CallOption) (*ReduceBlackFriendsFromCacheResp, error)
}
...
func (c *cacheClient) SwitchBroadcast(ctx context.Context, in *SwitchBroadcastReq, opts ...grpc.CallOption) (*SwitchBroadcastResp, error) {
	out := new(SwitchBroadcastResp)
	err := c.cc.Invoke(ctx, "/cache.cache/SwitchBroadcast", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cacheClient) GetBroadcast(ctx context.Context, in *GetBroadcastReq, opts ...grpc.CallOption) (*GetBroadcastResp, error) {
	out := new(GetBroadcastResp)
	err := c.cc.Invoke(ctx, "/cache.cache/GetBroadcast", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cacheClient) AddBlackFriendsForMomentsToCache(ctx context.Context, in *AddBlackFriendsToCacheReq, opts ...grpc.CallOption) (*AddBlackFriendsToCacheResp, error) {
	out := new(AddBlackFriendsToCacheResp)
	err := c.cc.Invoke(ctx, "/cache.cache/AddBlackFriendsForMomentsToCache", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cacheClient) ReduceBlackFriendsForMomentsFromCache(ctx context.Context, in *ReduceBlackFriendsFromCacheReq, opts ...grpc.CallOption) (*ReduceBlackFriendsFromCacheResp, error) {
	out := new(ReduceBlackFriendsFromCacheResp)
	err := c.cc.Invoke(ctx, "/cache.cache/ReduceBlackFriendsForMomentsFromCache", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CacheServer interface {
	...
	// broadcast
	SwitchBroadcast(context.Context, *SwitchBroadcastReq) (*SwitchBroadcastResp, error)
	GetBroadcast(context.Context, *GetBroadcastReq) (*GetBroadcastResp, error)
	AddBlackFriendsForMomentsToCache(context.Context, *AddBlackFriendsToCacheReq) (*AddBlackFriendsToCacheResp, error)
	ReduceBlackFriendsForMomentsFromCache(context.Context, *ReduceBlackFriendsFromCacheReq) (*ReduceBlackFriendsFromCacheResp, error)
}
...
func (UnimplementedCacheServer) SwitchBroadcast(context.Context, *SwitchBroadcastReq) (*SwitchBroadcastResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SwitchBroadcast not implemented")
}
func (UnimplementedCacheServer) GetBroadcast(context.Context, *GetBroadcastReq) (*GetBroadcastResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBroadcast not implemented")
}
func (UnimplementedCacheServer) AddBlackFriendsForMomentsToCache(context.Context, *AddBlackFriendsToCacheReq) (*AddBlackFriendsToCacheResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddBlackFriendsForMomentsToCache not implemented")
}
func (UnimplementedCacheServer) ReduceBlackFriendsForMomentsFromCache(context.Context, *ReduceBlackFriendsFromCacheReq) (*ReduceBlackFriendsFromCacheResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReduceBlackFriendsForMomentsFromCache not implemented")
}
...
func _Cache_SwitchBroadcast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SwitchBroadcastReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CacheServer).SwitchBroadcast(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cache.cache/SwitchBroadcast",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CacheServer).SwitchBroadcast(ctx, req.(*SwitchBroadcastReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Cache_GetBroadcast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBroadcastReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CacheServer).GetBroadcast(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cache.cache/GetBroadcast",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CacheServer).GetBroadcast(ctx, req.(*GetBroadcastReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Cache_AddBlackFriendsForMomentsToCache_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddBlackFriendsToCacheReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CacheServer).AddBlackFriendsForMomentsToCache(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cache.cache/AddBlackFriendsForMomentsToCache",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CacheServer).AddBlackFriendsForMomentsToCache(ctx, req.(*AddBlackFriendsToCacheReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Cache_ReduceBlackFriendsForMomentsFromCache_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReduceBlackFriendsFromCacheReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CacheServer).ReduceBlackFriendsForMomentsFromCache(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cache.cache/ReduceBlackFriendsForMomentsFromCache",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CacheServer).ReduceBlackFriendsForMomentsFromCache(ctx, req.(*ReduceBlackFriendsFromCacheReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Cache_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SwitchBroadcast",
			Handler:    _Cache_SwitchBroadcast_Handler,
		},
		{
			MethodName: "GetBroadcast",
			Handler:    _Cache_GetBroadcast_Handler,
		},
		{
			MethodName: "AddBlackFriendsForMomentsToCache",
			Handler:    _Cache_AddBlackFriendsForMomentsToCache_Handler,
		},
		{
			MethodName: "ReduceBlackFriendsForMomentsFromCache",
			Handler:    _Cache_ReduceBlackFriendsForMomentsFromCache_Handler,
		},
	},
